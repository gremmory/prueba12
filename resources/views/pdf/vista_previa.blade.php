...
<select name="cod_fase_pdf" id="cod_fase_pdf" required>
	...
	<option value="{{old('cod_fase_pdf')}}">Seleccionar Fase</option>
                ...
                , de <input type="text" name="num_lab" value=" {{old('num_lab')}} " size="3" required > Laboratorios conformados por: 
...
<p style="text-align: justify; padding-right: 30px; padding-left: 30px;"><span style="font-family: 'Calibri';">
	<strong><label name="cant_edu2" id="cant_edu2"></label> Computadoras port&aacute;tiles (NETBOOK EDUCATIVA):</strong></span></p>
...
<p style="text-align: justify; padding-right: 30px; padding-left: 30px;">&nbsp;</p>
<p style="padding-left: 30px;"><strong><label name="cant_doc2" id="cant_doc2"></label> Computadores port&aacute;tiles (Laptop para docentes): </strong></p>
...
<p style="text-align: justify; padding-right: 30px; padding-left: 30px;">&nbsp;</p>
<p style="padding-left: 30px;"><strong><label name="cant_ser2" id="cant_ser2"></label> Servidores (servidor de contenido):</strong></p>
